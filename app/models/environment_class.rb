class EnvironmentClass < ActiveRecord::Base
  ...
  def lookup_key_id=(val)
    Foreman::Deprecation.deprecation_warning("1.11", "lookup_key_id= is deprecated, please use puppetclass_lookup_key_id= instead.")
    self.puppetclass_lookup_key_id=val
  end

  def lookup_key=(val)
    Foreman::Deprecation.deprecation_warning("1.11", "lookup_key= is deprecated, please use puppetclass_lookup_key= instead.")
